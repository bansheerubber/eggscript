from eggscript_src.cache import add_cache_option, add_to_cache, has_been_modified, load_cache, save_cache
from eggscript_src.config import add_exported_lines, add_read_file, add_skipped_file, get_config, set_config
from eggscript_src.file import File
import traceback
from eggscript_src.tokenizer import Tokenizer
from time import time
from eggscript_src.misc.script_file import ScriptFile
...
def create_watcher(path):
	if sys.platform != "win32":
		...
		print("Watching not supported for Windows right now")
