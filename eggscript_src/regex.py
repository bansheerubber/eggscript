...
valid_start_of_symbol = re.compile(r'[A-Za-z_]')
...
vector_cross_token = re.compile(r'#')
...
vector_together_components = re.compile(r'(^xy$)|(^xyz$)|(^xyzw$)|(^yz$)|(^yzw$)|(^zw$)')
vector_token = re.compile(r'`')
vector_valid_replacements = re.compile(r'^[xyzw_]+$')
